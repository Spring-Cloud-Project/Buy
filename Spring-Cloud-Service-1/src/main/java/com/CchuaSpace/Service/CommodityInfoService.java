...
public class CommodityInfoService {
	...
	public List<CommodityInfoVo> SelectCommodityByNumber(String CommodityInfo, Model model) {
	...
	public List<CommodityInfoVo> SelectCommodityByID(@RequestBody String CommodityByID, Model model) {
